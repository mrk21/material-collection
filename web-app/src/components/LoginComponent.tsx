            ...
            return (
                <div>
                    ...
                    <form onSubmit={e => {
                        ...
                        <p><label>email:</label><input type="text" name="email" ref={node => emailNode = node} /></p>
                        <p><label>password:</label><input type="password" name="password" ref={node => passwordNode = node} /></p>
